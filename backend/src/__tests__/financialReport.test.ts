...
describe("Financial Report Functionality", () => {
    ...
    beforeAll(async () => {
        ...
        const transactions: ITransaction[] = [
            ...
            { id: 12, type: 'credit', amount: 500, category: "Travel", date: new Date("2024-09-20") },
            ...
            { id: 17, type: 'credit', amount: 600, category: "Home", date: new Date("2024-09-25") },
            { id: 18, type: 'credit', amount: 950, category: "Emergency Fund", date: new Date("2024-09-26") },
        ...
        const savingsGoals = [
            { title: "Travel", targetAmount: 2000, currentAmountSaved: 0 },
            { title: "Home", targetAmount: 5000, currentAmountSaved: 0 },
            { title: "Emergency Fund", targetAmount: 1000, currentAmountSaved: 0 }
        ]
    ...
    test("Should return summary of budget usage across different categories", () => {
        ...
        expect(user.budgetSummary(new Date("2024-09-05"), new Date("2024-09-15"))).toEqual(report);
    ...
    test("Should return progress towards savings goals", () => {
        ...
        expect(user.savingsGoalsProgress(new Date("2024-09-20"), new Date("2024-09-26"))).toEqual(report);
